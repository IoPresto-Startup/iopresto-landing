<template>
	<BaseCard :title="$t('esg.sdgs.title', 'Obiettivi di sviluppo')">
		<template #content>
			<p>
				{{ t("esg.sdgs.subtitle") }}
			</p>
			...
			<div
				class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-10 md:mb-12"
			>
				<div
					v-for="sdg in sdgs"
					:key="sdg.number"
				...
				>
					<div
						class="flex flex-col gap-6 justify-center items-center text-center"
					>
						<div
						...
						<p
							class="text-sm md:text-base leading-relaxed text-gray-600 dark:text-gray-300"
						>
							{{ sdg.description }}
						</p>
					</div>
